...
class HelloPythonWidget:
  ...
  def setup(self):
    ...
    ########################
    helloWorldButton1 = qt.QPushButton("Hello world")
    helloWorldButton1.toolTip = "Print 'Hello world' in standard ouput."
    sampleFormLayout.addWidget(helloWorldButton1)
    helloWorldButton1.connect('clicked(bool)', self.onHelloWorldButton1Clicked)

    helloWorldButton2 = qt.QPushButton("Hello Python")
    helloWorldButton2.toolTip = "Print 'Hello Python' in standard ouput."
    sampleFormLayout.addWidget(helloWorldButton2)
    helloWorldButton2.connect('clicked(bool)', self.onHelloWorldButton2Clicked)
    # Add vertical spacer
    self.layout.addStretch(1)

    # Set local var as instance attribute
    self.helloWorldButton1 = helloWorldButton1
    self.helloWorldButton2 = helloWorldButton2

  def onHelloWorldButton1Clicked(self):
    print "Hello World !"
  ...
  def onHelloWorldButton2Clicked(self):
    print 'Hello Python!'
    qt.QMessageBox.information(slicer.util.mainWindow(),'SlicerPython','HelloPython!')
