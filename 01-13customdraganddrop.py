...
class DropLineEdit(QLineEdit):
    ...
    def dragEnterEvent(self, event):
        print ('DropLineEdit-dragEnterEvent')
    ...
    def dragMoveEvent(self, event):
        print ('DropLineEdit-dragMoveEvent')
        if event.mimeData().hasFormat("application/x-icon-and-text"):
...
class DnDListWidget(QListWidget):
    ...
    def dragEnterEvent(self, event):
        print ('DnDListWidget-dragEnterEvent')
        if event.mimeData().hasFormat("application/x-icon-and-text"):
            event.accept()
        else:
            event.ignore()
    ...
    def dragMoveEvent(self, event):
        print ('DnDListWidget-dragMoveEvent')
        if event.mimeData().hasFormat("application/x-icon-and-text"):
...
class DnDWidget(QWidget):
    ...
    def minimumSizeHint(self):
        print ('DnDWidget-minimunSizeHint')
    ...
    def dragEnterEvent(self, event):
        print ('DnDWidget-dragEnterEvent')
        if event.mimeData().hasFormat("application/x-icon-and-text"):
            event.accept()
        else:
            event.ignore()
    ...
    def mouseMoveEvent(self, event):
        print ('DnDWidget-mouseMoveEvent')
        self.startDrag()
        QWidget.mouseMoveEvent(self, event)


    def startDrag(self):
        print ('DnDWidget-startDrag')
        print ('a')
        icon = self.icon
        if icon.isNull():
            return
