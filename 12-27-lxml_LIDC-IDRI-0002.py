...
root_LIDC = tree_LIDC.getroot()   # 获取根节点
...
##        etree.tostring(root_xmlformat, pretty_print=True)
    ...
    ##        print item.tag
            for element in item:
                ...
                f = file('E:\github\python\PythonStudy\LIDC-IDRI-0004.xml','a')
                tree_LIDC.write(f,pretty_print=True, xml_declaration=True, encoding='utf-8')
