...
import _0109addeditmoviedlg
import _0109moviedata
import _0109qrc_resources
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.movies = _0109moviedata.MovieContainer()
    ...
    def updateTable(self, current=None):
        ...
        for row, movie in enumerate(self.movies):
            ...
            if current is not None and current == id(movie):
                selected = item
            self.updateItem(row, movie, item)
    ...
    def updateItem(self, row, movie, item):
    ...
    def editAdd(self):
        form = _0109addeditmoviedlg.AddEditMovieDlg(self.movies, None,
                                               self)
        if form.exec_():
    ...
    def editEdit(self):
        ...
        if movie is not None:
            form = _0109addeditmoviedlg.AddEditMovieDlg(self.movies,
                                                   movie, self)
            if form.exec_():
